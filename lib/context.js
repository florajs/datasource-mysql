...
const { escape, raw } = require('mysql');
...
class Context {
    ...
    query(sql, values) {
        ...
        return this.ds._query(Object.assign({}, { type: 'SLAVE' }, this.ctx), sql).then(({ results }) => results);
    }
    ...
    queryRow(sql, values) {
        if (typeof values !== 'undefined') sql = bindParams(sql, values);
        return this.ds._query(Object.assign({}, { type: 'SLAVE' }, this.ctx), sql).then(getRow);
    }
    ...
    queryOne(sql, values) {
        if (typeof values !== 'undefined') sql = bindParams(sql, values);
        return this.ds._query(Object.assign({}, { type: 'SLAVE' }, this.ctx), sql).then(getField);
    }
    ...
    queryCol(sql, values) {
        if (typeof values !== 'undefined') sql = bindParams(sql, values);
        return this.ds._query(Object.assign({}, { type: 'SLAVE' }, this.ctx), sql).then(getColumn);
    }
    ...
    exec(sql, values) {
        if (typeof values !== 'undefined') sql = bindParams(sql, values);
        return this.ds
            ._query(Object.assign({}, { type: 'MASTER' }, this.ctx), sql)
    ...
    transaction() {
        ...
        return this.ds
            ._getConnection(Object.assign({}, this.ctx, { type: 'MASTER' }))
            .then(connection => {
