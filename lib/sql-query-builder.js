...
var createBinaryExpr = require('flora-sql-parser').util.createBinaryExpr;
...
module.exports = function (req) {
    ...
    if (req.groupAttribute) throw new ImplementationError('flora-mysql does not support "groupAttribute" yet');

    qb = new SqlQueryBuilder(req.queryAST);
